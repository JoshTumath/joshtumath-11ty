...
Using that string, you can use a set of CSS rules or run a script _only if_ the user is viewing your site on a viewport that’s at least 480 pixels wide.
...
- If this had been done using graceful degradation, users on smaller screens may have had to download images specified in the stylesheets for larger screens _and_ the images for smaller screens.
...
The _de facto_ standard widths used for responsive “breakpoints” are 320px, 480px, 600px, 768px and 960px, but you are of course free to use whatever values you need.[^2]
